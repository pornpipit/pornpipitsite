...
function wp_themeisle_customize_register( $wp_customize ) {
    ...
    if ( class_exists( 'WP_Customize_Panel' ) ) :
        ...
        $wp_customize->add_panel( 'panel_15', array(
            'priority' => 34,
            'capability' => 'edit_theme_options',
            'theme_supports' => '',
            'title' => __( 'Product section', 'zerif' )
        ) );

        /* PRODUCT SETTINGS */

        $wp_customize->add_section( 'zerif_product_settings_section' , array(
            'title'       => __( 'Settings', 'zerif' ),
            'priority'    => 1,
            'panel' => 'panel_15'
        ));
        ...
        /* zerif_product_show */
        $wp_customize->add_setting( 'zerif_product_show', array(
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( 'zerif_product_show', array(
            'type' => 'checkbox',
            'label' => __( 'Hide product section?','zerif' ),
            'description' => __( 'If you check this box, the Product section will disappear from homepage.','zerif' ),
            'section' => 'zerif_product_settings_section',
            'priority'    => 1,
        ) );

        /* zerif_product_number */
        $wp_customize->add_setting( 'zerif_product_number', array(
            'sanitize_callback' => 'zerif_sanitize_text',
            'default' => '8'
        ) );

        $wp_customize->add_control( 'zerif_product_number', array(
            'label'    => __( 'Maximum number of products to display on homepage', 'zerif' ),
            'section'  => 'zerif_product_settings_section',
            'priority'    => 2,
        ));
        ...
        $wp_customize->add_section( 'zerif_product_texts_section' , array(
            'title'       => __( 'Content', 'zerif' ),
            'priority'    => 2,
            'panel' => 'panel_15'
        ));
        ...
        /* zerif_product_title */
        $wp_customize->add_setting( 'zerif_product_title', array(
            'sanitize_callback' => 'zerif_sanitize_text',
            'default' => __( 'Product','zerif' ),
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( 'zerif_product_title', array(
            'label'    => __( 'Main title', 'zerif' ),
            'section'  => 'zerif_product_texts_section',
            'priority'    => 3,
        ));

        /* zerif_product_subtitle */
        $wp_customize->add_setting( 'zerif_product_subtitle', array(
            'sanitize_callback' => 'zerif_sanitize_text',
            'default' => __( 'Product subtitle','zerif' ),
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( 'zerif_product_subtitle', array(
            'label'    => __( 'Subtitle', 'zerif' ),
            'section'  => 'zerif_product_texts_section',
            'priority'    => 4,
        ));
        ...
        $wp_customize->add_section( 'zerif_product_single_section' , array(
            'title'       => __( 'Single page', 'zerif' ),
            'priority'    => 3,
            'panel' => 'panel_15'
        ));

        $wp_customize->add_setting( 'zerif_product_single_full');

        $wp_customize->add_control( 'zerif_product_single_full', array(
            'type' => 'checkbox',
            'label' => __( 'Full width page?','zerif' ),
            'description' => __( 'If you check this box, the single product page will be full width, with no sidebar.','zerif' ),
            'section' => 'zerif_product_single_section',
            'priority'    => 1,
        ) );

        /* PRODUCT COLORS */

        $wp_customize->add_section( 'zerif_product_colors_section' , array(
            'title'       => __( 'Colors', 'zerif' ),
            'priority'    => 4,
            'panel' => 'panel_15'
        ) );

        /* zerif_product_background */
        $wp_customize->add_setting( 'zerif_product_background', array(
            'default' => '#fff',
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( new Zerif_Customize_Alpha_Color_Control( $wp_customize, 'zerif_product_background', array(
            'label'    => __( 'Background color', 'zerif' ),
            'palette' => true,
            'section'  => 'zerif_product_colors_section',
            'priority'   => 1
        ) ) );

        /* zerif_product_header */
        $wp_customize->add_setting( 'zerif_product_header', array(
            'default' => '#404040',
            'transport' =>'postMessage'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_product_header', array(
            'label'      => __( 'Main title and subtitle colors', 'zerif' ),
            'section'    => 'zerif_product_colors_section',
            'priority'   => 2
        ) ) );
        ...
        /* zerif_product_text */
        $wp_customize->add_setting( 'zerif_product_text', array(
            'default' => '#fff',
            'transport' => 'postMessage'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_product_text', array(
            'label'      => __( 'Product box texts', 'zerif' ),
            'section'    => 'zerif_product_colors_section',
            'priority'   => 3
        ) ) );

        /* zerif_product_box_underline_color */
        $wp_customize->add_setting( 'zerif_product_box_underline_color', array(
            'default' => '#e96656'
        ) );

        $wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'zerif_product_box_underline_color', array(
            'label'      => __( 'Product box title undeline color', 'zerif' ),
            'section'    => 'zerif_product_colors_section',
            'priority'   => 4
        ) ) );
        ...
        $wp_customize->add_section( 'zerif_product_section' , array(
            'title'       => __( 'Product section', 'zerif' ),
            'priority'    => 34
        ));

        /* zerif_product_show */
        $wp_customize->add_setting( 'zerif_product_show');

        $wp_customize->add_control( 'zerif_product_show', array(
            'type' => 'checkbox',
            'label' => __( 'Hide product section?','zerif' ),
            'description' => __( 'If you check this box, the Product section will disappear from homepage.','zerif' ),
            'section' => 'zerif_product_section',
            'priority'    => 1,
        ) );
